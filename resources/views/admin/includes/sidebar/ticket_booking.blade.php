<li class="menu-item menu-item-submenu {{ $helper->isActivate(['admin.ticket_booking.index', 'admin.ticket_booking.create', 'admin.ticket_booking.edit']) }}" aria-haspopup="true" data-menu-toggle="hover">
