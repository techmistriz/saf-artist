                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="category_id[]" tabindex="null" required multiple="">
                                    <!-- <option value="">Select</option> -->
                                    @if($categories->count())
                                        @foreach($categories as $category)

                                           <option {{ in_array($category->id, old('category_id', $row->category_id ?? [])) ? 'selected' : '' }} value="{{$category->id}}">{{$category->name}}</option>
