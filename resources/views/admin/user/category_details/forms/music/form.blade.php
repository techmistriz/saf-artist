                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="light_designer_needed" tabindex="null" >
                                    <option value="">Select</option>
                    ...
                    <div class="col-6">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="sound_designer_needed" tabindex="null" >
                                    <option value="">Select</option>
                    ...
                    <div class="col-6">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="iprs_license_required" tabindex="null" >
                                    <option value="">Select</option>
