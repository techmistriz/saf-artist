                    ...
                    <div class="col-6">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                            	...
                            	<input type="text" name="no_of_people_in_group" value="{{ old('no_of_people_in_group') ? old('no_of_people_in_group') : ( isset($row->no_of_people_in_group) ? $row->no_of_people_in_group : '') }}" class="form-control" placeholder="Enter Details"/>
