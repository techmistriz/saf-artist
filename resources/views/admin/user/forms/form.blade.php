            ...
            <div class="card-body" id="artist">
                ...
                <div class="row">
                	...
                	<div class="col-6">
                        <div class="form-group">
                            <label>Country </label>
                            <select name="pa_country_id" id="pa_country_id" class="form-control selectpicker @error('pa_country_id') is-invalid @enderror" onchange="getStates(this, 'pa_country_id', 'pa_state_id', 'State'); checkOtherCountry(this)">
                    ...
                    <div class="col-6 state-wrapper" style="display: {{ old('pa_country_id', $row->pa_country_id ?? 0) == 2 ? 'none' : ''; }}">
                        <div class="form-group">
                            <label>State </label>
                            <select name="pa_state_id" id="pa_state_id" class="form-control selectpicker @error('pa_state_id') is-invalid @enderror" onchange="getCities(this, 'pa_state_id', 'pa_city_id', 'City')">
                	...
                	<div class="col-6 state-wrapper" style="display: {{ old('pa_country_id', $row->pa_country_id ?? 0) == 2 ? 'none' : ''; }}">
                        <div class="form-group">
                            <label>City</label>
                           	<select name="pa_city_id" id="pa_city_id" class="form-control selectpicker @error('pa_city_id') is-invalid @enderror" data-live-search="true" onchange="checkOtherCity(this, 'pa-city-other')">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label>Organisation/ Foundation/ Trust you are associated with (if any)</label>
                    ...
                    <div class="col-6" id="company_collective" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? 'display:none;' :''}}">
                        <div class="form-group">
                            <label>Company/Collective (If Applicable) </label>
                    ...
                    <div class="col-6" id="members_numbers" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? 'display:none;' :''}}">
                        <div class="form-group">
                            <label>Max Member Allowed </label>
                ...
                <div class="row">
                    <div class="col-6" id="stage_name" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? '' :'display:none;'}}">
                        <div class="form-group">
                            <label>Stage Name <i>(If Any)</i></label>
                ...
                <div class="row">
                	<div class="col-6" id="website" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? '' :'display:none;'}}">
                        <div class="form-group">
                            <label>Website <i>(If Any)</i> </label>
                    ...
                    <div class="col-6" id="other_link" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? '' :'display:none;'}}">
                        <div class="form-group">
                            <label>Link with videos of your work </label>
                ...
                <div class="row">
                	<div class="col-12" id="practice_image_1" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? '' :'display:none;'}}">
                        <div class="form-group">
                            <label>Please upload 3 high resolution images of your practice. </label>
                            <div class="row pb-5">
                                <div class="col-4">                                        
                    ...
                    <div class="col-12" id="practice_image_2" style="{{ isset($row->frontendRole->name) && ($row->frontendRole->name == 'Individual') ? '' :'display:none;'}}">
                        <div class="form-group">
                            <label>Please upload 2 high resolution profile images. </label>
                            <div class="row pb-5">
                                <div class="col-6">                                        
                ...
                <div class="row">
                	<div class="col-6">
                        <div class="form-group">
                            <label>Have you been associated with Serendipity Arts in the past ? </label>
