                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <input type="text" name="name" value="{{$row->name}}" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror " readonly />
                                @error('name')
                    ...
                    <div class="col-12">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <textarea class="form-control form-control-lg form-control-solid @error('permanent_address') is-invalid @enderror  no-summernote-editor" name="permanent_address" id="permanent_address" readonly >{{ $row->permanent_address}}</textarea>
