                                ...
                                <select class="form-control form-control-lg form-control-custom selectpicker" name="project_year" tabindex="null" onchange="getFestival()" required>
                                    ...
                                    @if( isset($project_years) && count($project_years))
                                        @foreach($project_years as $year)
                                           ...
                                           <option {{ old('project_year', $row->project_year ?? '' ) ? 'selected' : '' }} value="{{$year}}">{{$year}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('project_year')
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <textarea class="form-control form-control-lg form-control-solid no-summernote-editor" name="artist_bio" id="artist_bio" placeholder="Enter Artist Bio">{{ old('artist_bio', $row->artist_bio ?? '') }}</textarea>
                                @error('artist_bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
