                	...
                	<form action="{{ route('update.travel_boarding.details') }}" method="POST" enctype="multipart/form-data">
	                    ...
	                    <div class="card-header">
			                ...
			                <div class="card-title">
			                    <h3 class="card-label">Travel, Boarding & Lodging Details</h3>
			                </div>
	                    ...
	                    <div class="card-body">
			                <!-- Ticket Booking -->
			                @include('frontend.travel_boarding_details.forms.ticket_booking_form')

			                <!-- Hotel Booking -->
			                @include('frontend.travel_boarding_details.forms.hotel_booking_form')
			                
			                <!-- Ground Transport Booking -->
			                @include('frontend.travel_boarding_details.forms.ground_transport_booking_form')
