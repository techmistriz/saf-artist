<div class="row">
        ...
        <div class="form-group row validated">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="input-group date">
                    <input type="text" name="check_in_date" value="{{ old('check_in_date', $row->travelBoarding->check_in_date ?? '') }}" class="form-control form-control-solid form-control-lg kt_datepicker" placeholder="Enter Date of Travel" readonly />
    ...
    <div class="col-12">
        <div class="form-group row validated">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="input-group date">
                    <input type="text" name="check_out_date" value="{{ old('check_out_date', $row->travelBoarding->check_out_date ?? '') }}" class="form-control form-control-solid form-control-lg kt_datepicker" placeholder="Enter Date of Travel" readonly />
    ...
    <div class="col-12">
        <div class="form-group row validated">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <input type="text" name="total_room_nights" value="{{ old('total_room_nights', $row->travelBoarding->total_room_nights ?? '') }}" class="form-control form-control-solid form-control-lg" placeholder="Enter Details" readonly="" />
