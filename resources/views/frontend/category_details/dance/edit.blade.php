			                ...
			                <div class="row">
			                    ...
			                    <div class="col-12">
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
											<input type="text" name="no_of_people_in_group" oninput="this.value=this.value.replace(/[^0-9]/, '')" value="{{ old('no_of_people_in_group') ? old('no_of_people_in_group') : ( isset($row->no_of_people_in_group) ? $row->no_of_people_in_group : '') }}" class="form-control form-control-lg form-control-solid" {{isset($row->no_of_people_in_group) ? '':''}} placeholder="Enter Details"/>
			                    ...
			                    <div class="col-12">
			                        ...
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
											<input type="text" name="form_genre" value="{{ old('form_genre') ? old('form_genre') : ( isset($row->form_genre) ? $row->form_genre : '') }}" class="form-control form-control-lg form-control-solid" placeholder="Enter Form / Genre"/>
			                    ...
			                    <div class="col-12">
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
			                                <input type="text" name="synopsis_description_of_the_performance" value="{{ old('synopsis_description_of_the_performance') ? old('synopsis_description_of_the_performance') :( isset($row->synopsis_description_of_the_performance) ? $row->synopsis_description_of_the_performance : '') }}" class="form-control form-control-lg form-control-solid" maxlength="15"  placeholder="Enter Synopsis/ Description of the performance"/>
			                        ...
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
			                                <select class="form-control form-control-lg form-control-solid selectpicker" name="light_designer_needed" tabindex="null" >
			                                    <option value="">Select</option>
			                                    <option value="Yes" {{ old('light_designer_needed', $row->light_designer_needed ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>

			                                    <option value="No" {{ old('light_designer_needed', $row->light_designer_needed ?? '') == 'No' ? 'selected' : '' }}>No</option>

			                                    <option value="Maybe" {{ old('light_designer_needed', $row->light_designer_needed ?? '') == 'Maybe' ? 'selected' : '' }}>Maybe</option>
			                                </select>

			                                @error('light_designer_needed')
			                                    <div class="invalid-feedback">{{ $message }}</div>
			                                @enderror
			                        ...
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
			                                <select class="form-control form-control-lg form-control-solid selectpicker" name="sound_designer_needed" tabindex="null" >
			                                    <option value="">Select</option>
			                                    <option value="Yes" {{ old('sound_designer_needed', $row->sound_designer_needed ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>

			                                    <option value="No" {{ old('sound_designer_needed', $row->sound_designer_needed ?? '') == 'No' ? 'selected' : '' }}>No</option>

			                                    <option value="Maybe" {{ old('sound_designer_needed', $row->sound_designer_needed ?? '') == 'Maybe' ? 'selected' : '' }}>Maybe</option>
			                                </select>

			                                @error('sound_designer_needed')
			                                    <div class="invalid-feedback">{{ $message }}</div>
			                                @enderror
			                        ...
			                        <div class="form-group row validated">
			                            ...
			                            <div class="col-lg-9 col-md-9 col-sm-12">
			                                <select class="form-control form-control-lg form-control-solid selectpicker" name="iprs_license_required" tabindex="null" >
			                                    <option value="">Select</option>
			                                    <option value="Yes" {{ old('iprs_license_required', $row->iprs_license_required ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>

			                                    <option value="No" {{ old('iprs_license_required', $row->iprs_license_required ?? '') == 'No' ? 'selected' : '' }}>No</option>

			                                    <option value="Maybe" {{ old('iprs_license_required', $row->iprs_license_required ?? '') == 'Maybe' ? 'selected' : '' }}>Maybe</option>
