...
{   
    ...
    public function edit($id, TicketBooking $ticket){
        ...
        return view('frontend.ticket_booking.edit')->with('row', $row)->with(['countries' => $countries, 'cities' => $cities, 'travelModes' => $travelModes, 'projects' => $projects, 'members' => $members]);
    }
